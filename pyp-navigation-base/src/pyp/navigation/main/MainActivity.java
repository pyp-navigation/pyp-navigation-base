...
public class MainActivity extends SlidingFragmentActivity {
	...
	/**
	 * 方法 initFragment 初始化FragmentManager，默认显示HomeFragment，隐藏其他
	 */
	private void initFragment() {
		...
		ft.add(R.id.content_frame, mSettingFragment,
				SettingFragment.class.getName());
		ft.add(R.id.content_frame, mAssociationFragment,
				AssociationFragment.class.getName());
		ft.add(R.id.content_frame, mAssociationDetailFragment,
				AssociationDetailFragment.class.getName());
		ft.add(R.id.content_frame, mScheduleFragment,
	...
	/**
	 * 方法 changeFragment 切换到fragment
	 * 
	 * @param mFragment
	 *            要切换到的fragment的包名+类名 可以用 .class.getName()获取
	 */
	...
	/**
	 * 方法 changeTouchMode 根据下一个fragment的类名包名，来改变菜单触摸触发方式
	 * 
	 * @param mFragment
	 *            下一个fragment的类名.包名
	 */
	private void changeTouchMode(String mFragment) {
		...
		if (mFragment.equals(ScheduleFragment.class.getName())) {
			setTouchMode(2);
			return;
		}
	...
	/**
	 * 方法 showAssociationDetail 隐藏社团列表页面 - 传入社团信息 - 打开社团详情页面
	 * 
	 * @param mAssociation
	 *            社团信息封装类
	 */
	...
	/**
	 * 方法 hideAssociationDetail 隐藏社团详情页面 - 回到社团列表页面
	 */
